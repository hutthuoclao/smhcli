...
$currentDate = Get-Date -Format "yyyyMMdd_HHmmss"                              	#Get current Date
    ...
    $title = "PC23Node2"	        #>> sua o day                                            	#Name to show in window
    $walletAddress = "sm1qqqqqqrrzcy40ghvvt7uujfmkczkhrqruud787spzz3c8"  	#Your Wallet Address
    $provider = "0"								#Your GPU Number
    $numunits = "4" 								# 1 unit = 64GB >> sua o day
    $postFileLocation = "PC23Node2.256"						#PoST Location >> sua o day
